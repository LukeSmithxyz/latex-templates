...
\entry{In Progress}
	...
	{A planned linguistic corpus of the Latin language, to be searchable by regexes and grammatical category, with an interface written in Python. As of now I've constructed the parser to generate the corpus from raw text files.}
	{}
...
\entry{Pre-release}
	{\href{https://github.com/LukeSmithxyz/memespeaker} {Memespeaker}}
