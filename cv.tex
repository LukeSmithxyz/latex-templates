...
\hfill{}\href[gray]{http://LukeSmith.xyz/cv.pdf}{http://LukeSmith.xyz/cv.pdf \pdf}
...
\begin{tabular}{rp{.75\linewidth}}
	...
	\www{} : &\href{http://www.lukesmith.xyz}{lukesmith.xyz}
\end{tabular}
\end{minipage}
\begin{minipage}[t]{.5\linewidth}
\begin{tabular}{rl}
...
\entry{2012}
	{Exchange Program, Zhèngzhōu Dàxué (\cfont{郑州大学})}
	{Zhèngzhōu, China}
...
Current projects and other information can be found on \href{http://lukesmith.xyz/linguistics.html}{http://lukesmith.xyz/linguistics \www}.
...
\entry{2017}
	{``Language as Synesthesia'' \href{https://www.youtube.com/watch?v=he4-K3Ir1PY&list=PL-p5XmQHB_JQdpstJQ4DH18GZ8qt3KVxq}{\yt} \href{http://lukesmith.xyz/dox/etc/luke_synesthesia.pdf}{\pdf}}
...
Matlab/Octave, R, RStudio, Blender, Praat, Audacity, E-Prime, GIMP, pandoc, Jupyter. I've managed websites manually via ssh and vim using HTML/CSS/PHP and with tools such as Github Pages (Jekyll) WordPress via either cpanel or wp-cli.
...
\entry{2017--Now}
	{Luke's Auto-Rice Bootstrapping Scripts (LARBS) \href{http://larbs.xyz}{\www} \href{https://github.com/LukeSmithxyz/larbs}{\gh}}
...
As of January 2018, over 13,000 subscribers, with 1.4 millions views on 95 different videos. All of these series below are ongoing.

%\entry{R and Statistics}
	%{\footnotesize
	%[1]: Arithmetic, Variables and Vectors
	%[2]: Basic Functions
	%[3]: Variance Correlation and Standard Deviation
	%[4]: Playing Around with Normal Distributions
	%}
	%{}{}
...
\entry{2014--2015}
	...
	{\uga}
	{Managed email, reviewed papers and did and audio and video for conference.}
...
Section incomplete. Only contains major degree requirements now. To be updated. More minor squibs of mine can be found at \href{http://lukesmith.xyz/linguistics}{http://lukesmith.xyz/linguistics \www}.
...
\item I upload all of my teaching evaluations to \href{http://lukesmith.xyz/classes\#evals}{http://lukesmith.xyz/classes\#evals \www} and they can be read there.
\end{itemize}

\section{Coming Soon\ldots}

A video tutorial series on R and statistics---a video series on introductory linguistics
